...
RECOMMENDATION_SERVICE_URL = env.str('RECOMMENDATION_SERVICE_URL', 'http://localhost:8001')
IMAGE_MAX_WIDTH = 600
CREATE_RECOMMENDATION_TASK_NAME = env.str('CREATE_RECOMMENDATION_TASK_NAME', '')
RECOMMENDATION_SERVICE_QUEUE = env.str('RECOMMENDATION_SERVICE_QUEUE', 'fastapi')
